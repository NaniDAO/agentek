...
import { gasEstimatorTools } from "../src/shared/gasestimator";
import { cryptoPriceTools } from "../src/shared/cryptoprices";
import { estimateGasCostTool } from "../src/shared/gasestimator/tools";
...
async function main() {
  ...
  const estimates = await Promise.all([
    ...
    tools.estimateGasCost.execute({ chainId: 42161, gasUnits: standardGasUnits }),
