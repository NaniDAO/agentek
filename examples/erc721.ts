...
import { erc721Tools } from "../src/shared/erc721";
...
async function main() {
  ...
  const toolkit = new AgentekToolkit({
    ...
    tools: [...erc721Tools(), ...ensTools(), ...transferTools()],
  });
  ...
  const messages = [
    {
      role: "user",
      content:
        "who is the current owner of milady#721 (0x5af0d9827e0c53e4799bb226655a1de152a425a5)",
    },
  ] as CoreMessage[];
